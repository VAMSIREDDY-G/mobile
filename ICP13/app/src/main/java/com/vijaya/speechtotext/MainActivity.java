        ...
        tts = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR) {
                    ...
                    VoiceInput.setText(Html.fromHtml("<p style=\"color:#6ef33f;\"><b>Assistant :</b> Hello !!</p>"));
                }
            }
        });
            ...
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result != null && result.size() > 0) {
                        VoiceInput.append(Html.fromHtml("<p style=\"color:#f35c3f;\"><b>User :</b> "+result.get(0)+"</p>"));

                        if(result.get(0).equalsIgnoreCase("hello")) {
                            tts.speak(" What's your name ?", TextToSpeech.QUEUE_FLUSH, null);
                            VoiceInput.append(Html.fromHtml("<p style=\"color:#6ef33f;\"><b>Assistant :</b> What is your name ?</p>"));
                            ...
                            VoiceInput.append(Html.fromHtml("<p style=\"color:#6ef33f;\"><b>Assistant :</b> Hello, "+name+"</p>"));
                        }else if(result.get(0).contains("not feeling good")){
                            tts.speak("I can understand. Please tell your symptoms in short",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            VoiceInput.append(Html.fromHtml("<p style=\"color:#6ef33f;\"><b>Assistant :</b> I can understand. Please tell your symptoms in short</p>"));
                            ...
                            VoiceInput.append(Html.fromHtml("<p style=\"color:#6ef33f;\"><b>Assistant :</b> Thank you too, "+preferences.getString("name","")+" Take care.</p>"));
                            ...
                            VoiceInput.append(Html.fromHtml("<p style=\"color:#6ef33f;\"><b>Assistant :</b> The time is : "+sdfDate.format(now)+"</p>"));
                        }else if(result.get(0).contains("medicine")){
                            tts.speak("I think you have fever. Please take this medicine.",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            VoiceInput.append(Html.fromHtml("<p style=\"color:#6ef33f;\"><b>Assistant :</b> I think you have fever. Please take this medicine.</p>"));
                        } else {
                            tts.speak("Sorry, I cant help you with that", TextToSpeech.QUEUE_FLUSH, null);
                            VoiceInput.append(Html.fromHtml("<p style=\"color:#6ef33f;\"><b>Assistant :</b>Sorry, I cant help you with that</p>"));
                        }
                    }
                }
                break;
